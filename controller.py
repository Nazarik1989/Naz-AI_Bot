...
def build_clean_gpt_input(user_input: str, state: Dict[str, Any], task: Optional[str], source_topic: Optional[str]) -> str:
    ...
    lines.extend(
        [
            ...
            "- Бери конкретную сцену из выбранной смысловой оси. Бардак, баги, кривой код, "
            "сломанные интеграции и дожим используй только когда сам материал действительно про разработку; "
            "не превращай их в обязательную тему, сюжет или мораль.",
            ...
            "- Сохраняй голос Naz, но финал должен принадлежать теме, а не обязательно вести к дожиму результата.",
            "",
            "Ввод пользователя:",
            user_input.strip(),
        ]
