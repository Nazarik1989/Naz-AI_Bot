...
OP_SEAL_DRAFT_BUNDLE = "seal_draft_bundle"
...
OPERATIONS = frozenset({
    OP_HEALTH, OP_REGISTER_DRAFT, OP_SEAL_DRAFT_BUNDLE, OP_LATEST_STATE, OP_APPEND_REVIEW,
    OP_PREPARE_APPROVAL, OP_COMMIT_APPROVAL, OP_VERIFY_READY,
})

CAPABILITIES = {
    ROLE_NORMALIZER: frozenset({
        OP_HEALTH, OP_REGISTER_DRAFT, OP_SEAL_DRAFT_BUNDLE, OP_LATEST_STATE,
    }),
...
__all__ = (
    ...
    "OP_REGISTER_DRAFT", "OP_SEAL_DRAFT_BUNDLE", "OP_VERIFY_READY", "PROTOCOL_INVALID", "ProtocolError",
