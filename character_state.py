...
def prompt_context(state: CharacterState, plan: dict[str, str]) -> str:
    return (
        ...
        "Ядро неизменно: молодой талантливый билдер, любопытный и добрый под сарказмом. "
        "Используй это как взгляд и интонацию, а не как обязательную тему, сюжет или мораль. "
